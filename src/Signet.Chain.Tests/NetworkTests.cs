...
namespace Signet.Chain.Tests
{
   public class NetworkTests
   {
      ...
      public void CanGetNetworkFromName()
      {
         ...
         ////////Assert.Equal(netConfig.GetNetwork("signetmain"), signetMain);
         ////////Assert.Equal(netConfig.GetNetwork("SignetMain"), signetMain);
         ////////Assert.Equal(netConfig.GetNetwork("SignetRegTest"), signetRegtest);
         ////////Assert.Equal(netConfig.GetNetwork("signetregtest"), signetRegtest);
         ////////Assert.Equal(netConfig.GetNetwork("SignetTest"), signetTestnet);
         ////////Assert.Equal(netConfig.GetNetwork("signettest"), signetTestnet);
