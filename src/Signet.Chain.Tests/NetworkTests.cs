...
namespace Signet.Chain.Tests
{
   public class NetworkTests
   {
      ...
      {
         //Network signetMain = Networks.SignetMain;
         //Network cityRegtest = Networks.SignetRegTest;
         //Network cityTestnet = Networks.SignetTest;

         //Assert.Equal(NetworksContainer.GetNetwork("signetmain"), cityMain);
         //Assert.Equal(NetworksContainer.GetNetwork("SignetMain"), cityMain);
         //Assert.Equal(NetworksContainer.GetNetwork("SignetRegTest"), cityRegtest);
         //Assert.Equal(NetworksContainer.GetNetwork("signetregtest"), cityRegtest);
         //Assert.Equal(NetworksContainer.GetNetwork("SignetTest"), cityTestnet);
         //Assert.Equal(NetworksContainer.GetNetwork("signettest"), cityTestnet);
