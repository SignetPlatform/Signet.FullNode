...
namespace Signet.Chain.Tests.Features.Wallet
{
   public class WalletManagerTest : LogsTestBase, IClassFixture<WalletFixture>
   {
      ...
      public void CreateDefaultWalletAndVerify()
      {
         ...
         var walletManager = this.CreateWalletManager(dataFolder, SignetNetworks.Signet.Mainnet(), "-defaultwalletname=default", "-defaultwalletpassword=default", "-unlockdefaultwallet");
         walletManager.Start();
      ...
      // TODO: Temporarily disabled need to improve base test setup.
      [Fact]
      public void VerifyExecutionOfWalletNotify()
      {
         ...
         //	(ExtKey ExtKey, string ExtPubKey)
