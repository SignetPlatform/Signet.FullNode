        ...
        public static void Main(string[] args)
        {
            try
            {
                ...
                if (optionList.Contains("-help") || optionList.Contains("--help") || string.IsNullOrWhiteSpace(command))
                {
                    ...
                    builder.AppendLine(" dotnet run <Signet.Chain.Cli/Signet.Chain.Cli.dll> [network-name] [options] [method] <command> [arguments]");
                    builder.AppendLine();
                    ...
                    builder.AppendLine("dotnet run -rpcuser=stratistestuser -rpcpassword=stratistestpassword -rpcconnect=127.0.0.3 -rpcport=26174 getinfo - Displays general information about the Signet node on the 127.0.0.3:26174, authenticating with the RPC specified user.");
